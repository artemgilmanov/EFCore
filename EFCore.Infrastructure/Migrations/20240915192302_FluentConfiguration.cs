    ...
    public partial class FluentConfiguration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fluent_SubCategories", x => x.SubCategory_Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "George Orwell", "978-0451524935", 9.99m, 1, "1984" },
                    { 2, "Aldous Huxley", "978-0060850524", 9.99m, 2, "Brave New World" },
                    { 3, "Ray Bradbury", "978-1451673319", 9.99m, 1, "Fahrenheit 451" }
                });
